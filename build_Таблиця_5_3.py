"""
build_Таблиця_5_3.py
Генерує Таблиця_5_3.xlsx — показники впливу температури повітря на PM10
(pan2, pan6, pan5) — Таблиця 5.3 Розділу 5 дисертації
"""
import openpyxl
...
OUT = Path(__file__).parent / "Таблиця_5_3.xlsx"
...
ws = wb.active
ws.title = "Таблиця 5.3"

ws.merge_cells('A1:D1')
ws['A1'].value = "Таблиця 5.3 – Узагальнені показники для аналізу впливу зовнішньої температури"
