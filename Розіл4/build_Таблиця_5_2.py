"""
build_Таблиця_5_2.py
Генерує Таблиця_5_2.xlsx — показники впливу відносної вологості на PM10
(pan2, pan6, pan5) — Таблиця 5.2 Розділу 5 дисертації
"""
import openpyxl
...
OUT = Path(__file__).parent / "Таблиця_5_2.xlsx"
...
ws = wb.active
ws.title = "Таблиця 5.2"

ws.merge_cells('A1:D1')
ws['A1'].value = "Таблиця 5.2 – Узагальнені показники для аналізу впливу зовнішньої відносної вологості"
ws['A1'].font = Font(bold=True, name='Times New Roman', size=12)
ws['A1'].alignment = Alignment(horizontal='center', wrap_text=True)
ws.row_dimensions[1].height = 30

for c, h in enumerate(['Показник', 'pan2', 'pan6', 'pan5'], 1):
    hdr(ws, 2, c, h)
